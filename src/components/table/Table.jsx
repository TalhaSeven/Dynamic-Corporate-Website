        ...
        <div className="overflow-x-auto sm:-mx-6 lg:-mx-8 ">
            ...
            <div className="overflow-hidden rounded-2xl">
                ...
                <thead className="border-b bg-[#FF9B24] font-medium">
                    ...
                    <th scope="col" className="px-6 py-4 border-e-2 border-white">
                        Day
                    </th>
                    <th scope="col" className="px-6 py-4 border-e-2 border-white">
                        Hour
                ...
                <tbody>
                    ...
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Monday</td>
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Otto</td>
                    <td className="whitespace-nowrap px-6 py-4">@mdo</td>
                    </tr>
                    <tr className="border-b bg-[#ffecd6]">
                    
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Monday</td>
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Thornton</td>
                    ...
                    <tr className="border-b bg-[#fff6eb]">
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Monday</td>
                    <td className="whitespace-nowrap px-6 py-4 border-e-2 border-white">Larry the Bird </td>
