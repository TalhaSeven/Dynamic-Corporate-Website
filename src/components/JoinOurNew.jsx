...
const JoinOurNew = () => {
  return (
    <>
    <div
      className=" relative font-fredoka h-[440px]  md:h-[400px]"
   
    >
        <div className="w-full h-full">
            <img src="./image/joining-area.png" alt="" className="w-full h-full object-cover"/>
        </div>
      ...
      <div className="absolute inset-0 flex justify-center items-center flex-col space-y-8 text-white w-3/4 md:w-1/2 lg:w-5/12 mx-auto ">
        ...
        <p className="text-[14px] lg:text-[16px] text-center px-0 lg:px-8 w-full">
          Kindedo believes that good questions drive good answers. Whether it's
          a query about the world around us or a challenge.
        </p>
