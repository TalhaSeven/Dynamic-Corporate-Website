      ...
      <div className="container mx-auto">
        <div className="flex justify-center ">
          <div className="text-center basis-1/3 md:basis-1/2 mb-10">
            ...
            <p className="text-[15px] lg:text-[16px] min-h-[66px] md:min-h-[96px] xl:min-h-[70px] font-light">
          ...
          <SwiperSlide className="mb-10">
            ...
            <p className="text-[15px] lg:text-[16px] min-h-[66px] md:min-h-[96px] xl:min-h-[70px] font-light">Kindedo not only for all our dedicated 2023 reunion year groups program.</p>
