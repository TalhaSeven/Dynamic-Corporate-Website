    ...
    <div className="px-18 py-20 md:p-24 lg:p-30 bg-gradient-to-r from-[#FEF7EC] to-[#F1FCF8] font-fredoka">
      ...
      >
         ...
         <SwiperSlide >
            ...
            <p className="text-[15px] lg:text-[16px] min-h-[66px] md:min-h-[96px] xl:min-h-[66px] font-light">
          ...
          <div className="flex flex-col space-y-2 bg-white p-3 rounded-xl group justify-between ">
            ...
            <p className="text-[15px] lg:text-[16px] min-h-[66px] md:min-h-[96px] xl:min-h-[66px] font-light">Kindedo not only for all our dedicated 2023 reunion year groups program.</p>
